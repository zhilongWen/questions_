...
public final class WireFormat {
    ...
    static final int HIGHT_BIT = 0x80;
    ...
    public enum FieldType {
        DOUBLE(com.google.protobuf.WireFormat.JavaType.DOUBLE, WIRETYPE_FIXED64),
        FLOAT(com.google.protobuf.WireFormat.JavaType.FLOAT, WIRETYPE_FIXED32),
        INT64(com.google.protobuf.WireFormat.JavaType.LONG, WIRETYPE_VARINT),
        UINT64(com.google.protobuf.WireFormat.JavaType.LONG, WIRETYPE_VARINT),
        INT32(com.google.protobuf.WireFormat.JavaType.INT, WIRETYPE_VARINT),
        FIXED64(com.google.protobuf.WireFormat.JavaType.LONG, WIRETYPE_FIXED64),
        FIXED32(com.google.protobuf.WireFormat.JavaType.INT, WIRETYPE_FIXED32),
        BOOL(com.google.protobuf.WireFormat.JavaType.BOOLEAN, WIRETYPE_VARINT),
        STRING(com.google.protobuf.WireFormat.JavaType.STRING, WIRETYPE_LENGTH_DELIMITED) {
            @Override
            public boolean isPackable() {
                return false;
            }
        },
        GROUP(com.google.protobuf.WireFormat.JavaType.MESSAGE, WIRETYPE_START_GROUP) {
            @Override
            public boolean isPackable() {
                return false;
            }
        },
        MESSAGE(com.google.protobuf.WireFormat.JavaType.MESSAGE, WIRETYPE_LENGTH_DELIMITED) {
            @Override
            public boolean isPackable() {
                return false;
            }
        },
        BYTES(com.google.protobuf.WireFormat.JavaType.BYTE_STRING, WIRETYPE_LENGTH_DELIMITED) {
            @Override
            public boolean isPackable() {
                return false;
            }
        },
        UINT32(com.google.protobuf.WireFormat.JavaType.INT, WIRETYPE_VARINT),
        ENUM(com.google.protobuf.WireFormat.JavaType.ENUM, WIRETYPE_VARINT),
        SFIXED32(com.google.protobuf.WireFormat.JavaType.INT, WIRETYPE_FIXED32),
        SFIXED64(com.google.protobuf.WireFormat.JavaType.LONG, WIRETYPE_FIXED64),
        SINT32(com.google.protobuf.WireFormat.JavaType.INT, WIRETYPE_VARINT),
        SINT64(com.google.protobuf.WireFormat.JavaType.LONG, WIRETYPE_VARINT);

        FieldType(final com.google.protobuf.WireFormat.JavaType javaType, final int wireType) {
    ...
    static Object readPrimitiveField(
            CodedInputStream input, com.google.protobuf.WireFormat.FieldType type, Utf8Validation utf8Validation) throws IOException {
        switch (type) {
            case DOUBLE:
